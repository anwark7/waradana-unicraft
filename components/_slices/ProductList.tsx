...
const ProductList = ({slice}: Props): JSX.Element => {
	...
	return (
		<section className="flex-cc col gap-20 w-full py-10 md:py-16 xl:py-24 2xl:py-28 px-12 sm:px-13 md:px-24 lg:px-28 xl:px-32">
			{slice.items.map((item, index) => (
				<div className="flex-vs gap-6 -md:col w-full" key={index}>
					...
					<div className="flex-cc md:flex-bs gap-8 md:gap-16 col w-full md:w-7/12">
						<p className="text-primary font-bold text-4xl sm:text-5xl">
							{item.content.data.title}
						</p>
						<p className="!text-primary-lighter font-bold text-center md:text-left text-sm sm:text-base md:text-lg lg:text-2xl">
